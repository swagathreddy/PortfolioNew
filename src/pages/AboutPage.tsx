      ...
      <section className="py-20 bg-gradient-to-r from-neutral-900 to-neutral-800 relative overflow-hidden">
        ...
        <div className="container-custom relative z-10">
          ...
          >
            ...
            >
              Information Technology student with strong full-stack development skills and proven leadership experience.
            </motion.p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <SectionTitle
                ...
                title="Passionate Developer & AIML Enthusiast"
              />
              <div className="space-y-6 text-neutral-300">
                <p>As an Information Technology student at Anurag University, 
                  I've built a strong foundation in full-stack development, excelling in creating secure and 
                  scalable applications. My technical expertise spans frameworks like Django and the MERN stack 
                  (MongoDB, Express.js, React.js, Node.js), enabling me to deliver robust and user-focused solutions.
                </p>
                <p>My passion lies in leveraging artificial intelligence and machine learning to drive innovation.
                   With hands-on experience in supervised and unsupervised learning, I have worked extensively
                    with large language models (LLMs) like DeepSeek and Qwen. These, combined with my expertise 
                    in NLP tools, empower me to develop intelligent applications that address real-world challenges 
                    effectively.</p>
                <p>Beyond my technical acumen, I value leadership and collaboration. As a core member of GDSC at Anurag 
                  University, I have led cross-functional teams to successfully organize 10+ tech events, increasing 
                  engagement by 40%. Additionally, I have mentored over 50 students in web development, achieving an 
                  85% project completion rate.</p><p>Whether it's creating intelligent platforms or empowering others 
                    through mentorship, I am deeply committed to using technology to make a meaningful impact.
                </p>
              </div>
